...
class LRP:
    ...
    def generate(self, input_tensor, target_class=None):
        ...
        # For a simplified approach, we use the gradient*input method
        # This is a simpler version of LRP that provides meaningful relevance scores
        ...
        # Get gradients and multiply by input (gradient * input rule)
